...
- **Offline first**  
  Iow - if a solar CME kicks this civilization back to the stone age(again?) and you happen to have a working power source, you can still browse all your metadata || cached data to check on your appointments, emails, tax returns.. you no longer have to worry about (or browse cached content you need to worry about)
- **Developer friendly**  
  The whole stack is primarily designed to be actively worked on, git is your friend(no, thats really a feature:)
- **Extensions are first-class citizens** (whatever that may mean at this stage of development)
